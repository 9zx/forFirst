...
<TABLE cellSpacing=0 cellPadding=0 width=749 border=0>
  ...
  <TR vAlign=top>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width=173 border=0>
        ...
        <TR>
          ...
          <TD width=165 height="29" bgColor=#7691c7>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<A 
            class=nav 
            href="newOperator.jsp">ÐÂÔö²Ù×÷Ô±</A></TD>
        </TR>
        <!--TR>
        ...
        <TR>
          ...
          <TD width=165 height="29" bgColor=#7691c7>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<A 
            class=nav 
            href="modifyOperator.htm">ÐÞ¸Ä²Ù×÷Ô±</A></TD>
        </TR-->
        <TR>
          <TD bgColor=#ffffff colSpan=2><IMG height=1 
        ...
        <TR>
          ...
          <TD width=165 height="29" bgColor=#7691c7>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<A 
            class=nav 
            href="newUser.htm">Â¼ÈëÓÃ»§ÐÅÏ¢</A></TD>
        </TR>
        <TR>
          <TD bgColor=#ffffff colSpan=2><IMG height=1 
            src="images/blank.gif" width=1 border=0></TD></TR>
        <TR>
          ...
          <TD width=165 height="29" bgColor=#7691c7>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<A 
            class=nav 
            href="newAccount.htm">Â¼ÈëÕË»§ÐÅÏ¢</A></TD>
        </TR-->
    ...
    <TD width="2">
      <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY>
        <TR>
          <TD height=25>&nbsp;ÄúÏÖÔÚµÄÎ»ÖÃ£ºÐÂÔö²Ù×÷Ô±</TD>
        </TR>
        <TR>
  ...
  <TR vAlign=top>
    ...
    <form method="POST" action="--WEBBOT-SELF--">
      <p>µÇÂ¼ID£º<input type="text" name="T1" size="20" value="A00000001"></p>
      <p>ÐÕ Ãû£º<input type="text" name="T2" size="20" value="ÕÅÈý"></p>
      <p>ÃÜÂë£º<input type="password" name="T3" size="20" value="******"></p>
      <p>ÃÜÂëÈ·ÈÏ£º<input type="password" name="T4" size="20" value="******"></p>
      <p>ÊÇ·ñ¹ÜÀíÔ±£º<input type="radio" value="V1" checked name="R1">ÊÇ&nbsp;&nbsp;&nbsp; 
      <input type="radio" name="R1" value="V2">·ñ</p>
      <p><input type="submit" value="Ìá½»" name="B1"></p>
    </form>
    </TD>
    </TR>
  </TBODY></TABLE>
